...
exports.bookinstance_create_post = [
    ...
    asyncHandler(async (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render("bookinstance_form", {title: "Create book instance", book_list: allBooks, selected_book:bookInstance.book._id, errors: errors.array(), bookinstance: bookInstance});
            return;
        }
        else {
...
exports.bookinstance_update_get = asyncHandler(async (req, res, next) => {
    const [bookInstance, allBooks] = await Promise.all([BookInstance.findById(req.params.id).exec(), Book.find().exec()]);
    ...
    res.render("bookinstance_form", {title: "Update book instance", bookinstance: bookInstance, selected_book: bookInstance.book._id ,book_list: allBooks});
});
...
exports.bookinstance_update_post = [
    ...
    asyncHandler(async (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            res.render("bookinstance_form", {title: "Update book instance", book_list: allBooks, selected_book:bookInstance.book._id, errors: errors.array(), bookinstance: bookInstance});
            return;
        }
        else {
